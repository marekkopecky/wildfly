 ...
 * however, without a shared key. In this case, one nodes should accept the connection from second node, but second node should reject the connection.
 * So cluster should not be established.
 *
...
@ServerSetup({
        ...
        TLSServerSetupTasks.UnsharedOneTrustedOnlySecureJGroupsTransportServerSetupTask_NODE_1_2.class,
})
class TLSUniqueKeysOneWrongTrustStoreCommandDispatcherTestCase extends CommandDispatcherTestCase {
