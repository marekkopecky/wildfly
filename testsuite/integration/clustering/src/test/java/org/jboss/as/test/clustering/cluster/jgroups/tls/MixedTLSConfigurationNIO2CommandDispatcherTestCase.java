...
/**
 * Variation of the standard {@link CommandDispatcherTestCase} that uses SSL/TLS-secured JGroups communication channel and NIO2 transport,
...
@ServerSetup({
        ...
        TLSServerSetupTask.PerNodeSecureJGroupsTransport_TCP_NIO2_NODE_1.class,
})
class MixedTLSConfigurationNIO2CommandDispatcherTestCase extends CommandDispatcherTestCase {
